...
void setupMPU9150()
{
  Serial.println("MPU9150_SCL -> A5");
  Serial.println("MPU9150_SCA -> A4");
  ...
  // verify connection
  Serial.println(F("Testing MPU9150 connections..."));
...
void loopHX711() {
      raw_force = scale.get_units();
      scaled_force = (raw_force-OFFSET)/SCALE;
}
void loopMPU9150() {
...
void output() {  
    ...
    // For more see http://en.wikipedia.org/wiki/Conversion_between_quaternions_and_Euler_angles which has additional links.
      ...
      if (outputMode == FUSION)
      {
        ...
        //len = mavlink_msg_to_send_buffer(buf, &msg);
        //Serial.write(buf, len);
        mavlink_msg_scaled_pressure2_pack(system_id, component_id, &msg, time_boot_ms, raw_force, scaled_force, temperature);
        len = mavlink_msg_to_send_buffer(buf, &msg);
        Serial.write(buf, len);
      }
      ...
      */
      ...
      if (outputMode == DEBUG)
      {
        ...
        Serial.println(" m");
          ...
          Serial.print("Force: ");
          Serial.print(raw_force, 1); //raw value
          Serial.print(" ");
          Serial.print(scaled_force, 1); //scaled and offset after calibration
          Serial.print(" g"); 
          Serial.println();
      }

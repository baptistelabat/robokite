...
# Derived from CamShitDemo to select an area on a picture not a movie.
# Coordinates of the selection are saved in yaml file
# They can later be used to compute the histogram for object detection
